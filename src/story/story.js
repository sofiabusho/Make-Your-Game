...
export class StoryManager {
    constructor() {
        ...
        // Development scenes (shown at score milestones during gameplay)
        this.developmentScenes = [
            ...
            },
            {
                ...
                text: "You've reached a critical point! The reef is almost fully restored, but the darkness is making one last desperate push. The shadows are at their strongest now, and the fish are more elusive than ever. This is your moment to prove yourself as the true guardian of the reef!"
            }
        ];
    ...
    /**
     * Show development story (at score milestones)
    ...
    showDevelopment(currentScore, onContinue) {
        // Find the highest threshold we haven't shown yet
